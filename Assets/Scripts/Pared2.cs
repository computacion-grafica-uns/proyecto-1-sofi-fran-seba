...
public class Pared2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Pared_2.AddComponent<MeshRenderer>();
    ...
    private void CreateMaterial()
    {
        ...
        Pared_2.GetComponent<MeshRenderer>().material = newMaterial;
    }
    ...
    private void CreateModel()
    {
        ...
        {
            new Vector3(0,0,5), //Vertice 0
            new Vector3(0,2.5f,5), //Vertice 1
            new Vector3(2.5f,2.5f,5), //Vertice 2
            new Vector3(2.5f,0,5), //Vertice 3
            
            new Vector3(3.5f,2.5f,5), //Vertice 4
            new Vector3(3.5f,2,5), //Vertice 5
            new Vector3(2.5f,2,5), //Vertice 6

            new Vector3(7,2.5f,5), //Vertice 7
            new Vector3(7,0,5), //Vertice 8
            new Vector3(3.5f,0,5), //Vertice 9
    ...
    private void UpdateMesh()
    {
        ...
        Pared_2.GetComponent<MeshFilter>().mesh.vertices = vertices;

        //Actualizamos los triangulos de la malla
        Pared_2.GetComponent<MeshFilter>().mesh.triangles = triangles;
    }
