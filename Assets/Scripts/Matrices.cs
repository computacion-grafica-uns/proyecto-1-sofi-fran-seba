...
public static class Matrices
{
    ...
    {
        // Calcular el eje Forward (F), es la direcci�n desde la c�mara hacia el objetivo, normalizada.
    ...
    public static Matrix4x4 CalculatePerspectiveProjectionMatrix(float fov, float aspectRatio, float nearClipPlane, float farClipPlane)
    {
        ...
        // Fila 3: Factor de divisi�n W (proyectiva)
        m[3, 0] = 0.0f;
        m[3, 1] = 0.0f;
        m[3, 2] = -1.0f;
        m[3, 3] = 0.0f;
