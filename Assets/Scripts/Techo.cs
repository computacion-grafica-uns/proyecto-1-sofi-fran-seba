...
public class Techo : MonoBehaviour
{
    ...
    private void CreateMaterial()
    {
        ...
        techo.GetComponent<MeshRenderer>().material = newMaterial;
    }
    ...
    private void CreateModel()
    {
        ...
        {
            new Vector3(0,2.5f,0), //Vertice 0
            new Vector3(7,2.5f,0), //Vertice 1
            new Vector3(7,2.5f,5), //Vertice 2
            new Vector3(0,2.5f,5), //Vertice 3
    ...
    private void UpdateMesh()
    {
        ...
        techo.GetComponent<MeshFilter>().mesh.vertices = vertices;

        //Actualizamos los triangulos de la malla
        techo.GetComponent<MeshFilter>().mesh.triangles = triangles;
    }
