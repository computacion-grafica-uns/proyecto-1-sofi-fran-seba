...
public class Pared4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Pared_4.AddComponent<MeshRenderer>();
    ...
    private void CreateMaterial()
    {
        ...
        Pared_4.GetComponent<MeshRenderer>().material = newMaterial;
    }
