...
public class Pared3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Pared_3.AddComponent<MeshRenderer>();
    ...
    private void CreateMaterial()
    {
        ...
        Pared_3.GetComponent<MeshRenderer>().material = newMaterial;
    }
    ...
    private void CreateModel()
    {
        ...
        {
            new Vector3(7,0,0), //Vertice 0
            new Vector3(7,2.5f,0), //Vertice 1
            new Vector3(7,2.5f,1), //Vertice 2
            new Vector3(7,0,1), //Vertice 3
            new Vector3(7,2.5f,5), //Vertice 4
            new Vector3(7,0,5), //Vertice 5
            new Vector3(7,0,4), //Vertice 6
            new Vector3(7,0.5f,4), //Vertice 7
            new Vector3(7,2,4), //Vertice 8
            new Vector3(7,2,1), //Vertice 9
            new Vector3(7,0.5f,1), //Vertice 10
            new Vector3(7,2.5f,4), //Vertice 11
    ...
    private void UpdateMesh()
    {
        ...
        Pared_3.GetComponent<MeshFilter>().mesh.vertices = vertices;

        //Actualizamos los triangulos de la malla
        Pared_3.GetComponent<MeshFilter>().mesh.triangles = triangles;
    }
